...
typedef enum tag_eComDirection
{
	eCOM_DIRECTION_RX,
	eCOM_DIRECTION_TX
}eComDirection;
...
void fDinamyxel_setComDirection(uint32_t , uint32_t );
uint16_t fDinamyxel_reset(uint8_t);
uint16_t fDinamyxel_ping(uint8_t);

uint16_t fDinamyxel_setStatusPaketReturnDelay(uint8_t,uint8_t);
uint16_t fDinamyxel_setID(uint8_t, uint8_t);
uint16_t fDinamyxel_setBaudRate(uint8_t, long);
uint16_t fDinamyxel_setMaxTorque(uint8_t, int);
uint16_t fDinamyxel_setHoldingTorque(uint8_t, bool);
uint16_t fDinamyxel_setAlarmShutdown(uint8_t,uint8_t);
uint16_t fDinamyxel_setStatusPaket(uint8_t,uint8_t);
uint16_t fDinamyxel_setMode(uint8_t, bool, uint16_t, uint16_t);
uint16_t fDinamyxel_setPunch(uint8_t, uint16_t);
uint16_t fDinamyxel_setPID(uint8_t, uint8_t, uint8_t, uint8_t);
uint16_t fDinamyxel_setTemp(uint8_t, uint8_t);
uint16_t fDinamyxel_setVoltage(uint8_t, uint8_t, uint8_t);

uint16_t fDinamyxel_servo(uint8_t, uint16_t, uint16_t);
uint16_t fDinamyxel_servoPreload(uint8_t, uint16_t, uint16_t);
uint16_t fDinamyxel_wheel(uint8_t, bool, uint16_t);
void fDinamyxel_wheelSync(uint8_t, bool, uint16_t, uint8_t, bool, uint16_t, uint8_t, bool, uint16_t);
uint16_t fDinamyxel_wheelPreload(uint8_t, bool, uint16_t);

uint16_t fDinamyxel_action(uint8_t);

uint16_t fDinamyxel_readTemperature(uint8_t);
uint16_t fDinamyxel_readVoltage(uint8_t);
uint16_t fDinamyxel_readPosition(uint8_t);
uint16_t fDinamyxel_readLoad(uint8_t);
uint16_t fDinamyxel_readSpeed(uint8_t);

uint16_t fDinamyxel_checkRegister(uint8_t);
uint16_t fDinamyxel_checkMovement(uint8_t);
uint16_t fDinamyxel_checkLock(uint8_t);

uint16_t fDinamyxel_ledState(uint8_t, bool);


void fDinamyxel_transmitInstructionPacket(uint32_t);
uint16_t fDinamyxel_readStatusPacket(uint32_t);
void fDinamyxel_clearRXbuffer(uint32_t);
void fDinamyxel_Init(uint32_t);
